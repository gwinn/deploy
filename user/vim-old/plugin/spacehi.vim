...
if !exists("g:spacehi_spacecolor")
    " highlight trailing spaces in yellow underline
    let g:spacehi_spacecolor="ctermfg=11 cterm=underline"
    let g:spacehi_spacecolor=g:spacehi_spacecolor . " guifg=yellow gui=underline"
endif
